...
import aiohttp
import json
from lib.embed.leaderboard_embed import LeaderboardEmbed, color_list, medal_list
...
class NavButton(discord.ui.Button['RankingView']):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        embed = InteractableLeaderboardEmbed(self.view.title, self.view.user_list, self.view.current_page_number, self.view.pages_count, self.view.embed_limit, interaction)
