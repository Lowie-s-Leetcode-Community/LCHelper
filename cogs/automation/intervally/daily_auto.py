...
class DailyAutomation(commands.Cog):
    ...
    def create_new_daily_object(self):
        # fetch daily problem
        # call api to create new daily object
        return

    def create_new_user_daily_objects(self):
        # for all user in leaderboard -> create new daily object for them
        # should consider "distribute" this between this and crawl.
        return
    
    def create_daily_thread(self):
    ...
    async def daily(self):
        ...
        await self.create_new_daily_object()
        await self.create_new_user_daily_objects()
        await self.create_daily_thread()
